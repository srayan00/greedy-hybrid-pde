#!/bin/bash
#SBATCH --job-name=verify_rtr_fno
#SBATCH --partition=priority
#SBATCH --gres=gpu:1
#SBATCH --time=00:30:00
#SBATCH --output=logs/verify_router_fno_%j.out
#SBATCH --error=logs/verify_router_fno_%j.err
...
python -u verify_pipeline.py \
    ...
    --router_model_name hier_sor_fno_unrolled \
